...
png(filename = 'scripts/figures/figure_2C_ROC.png', width = 5, height = 5, units = 'in', res = 300)
...
# 'Calibrated' here is Calibrated + normalized to random proliferative model predictions
# i.e. the combined predictor
png(filename = 'scripts/figures/figure_2C_PR.png', width = 5, height = 5, units = 'in', res = 300)

...
```{r Correlation of ROC results (Cascade 1.0), dpi=300, cache=TRUE}
...
data_trap = bind_cols(as_tibble(1 - normalize_to_range(pred_ew$score)), as_tibble(pred_mw$synergy_prob_ss))

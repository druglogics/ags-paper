...
knitr::write_bib(c(.packages(), 'emba', 'usefun', 'rtemps', 'PRROC'), 'packages.bib')
```
...
The model with the coeeficients is as follows (adding an intercept makes ROC AUC result considerably worse):

...
```{r edge-heat-1, fig.cap='Edge annotated heatmap. All edges are included. Edges have been grouped to 4 clusters with K-means. Pathway annotation is included.'}
knitr::include_graphics(path = 'img/edge_heat.png')
```

```{r edge-heat-2, fig.cap='Edge annotated heatmap. A subset of the total edges is included, the least heterogeneous across all the models (rows) based on some user-defined thresholds. Edges have been grouped to 2 clusters with K-means. Pathway annotation is included.'}

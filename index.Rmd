...
```{r best-beta-cascade2-link, fig.width=5, fig.height=5, fig.align='center', dpi=300, cache=TRUE, fig.show='hold', out.width='50%', fig.cap='ROC and PR curves for Random and Combined Predictor (CASCADE 2.0, Link Operator Mutations)'}
best_beta1 = -1.6
best_beta2 = -1
...
```{r best-beta-cascade2-link-2, fig.width=5, fig.height=5, fig.align='center', dpi=300, cache=TRUE, fig.show='hold', out.width='50%', fig.cap='ROC and PR curves for Random, Calibrated and Combined Predictor (CASCADE 2.0, Link Operator Mutations)'}
# best_beta2 = -1
...
```{r param-comp-boot-fig-2, fig.align='center', warning=FALSE, dpi=300, cache=TRUE, fig.show='hold', out.width='50%', fig.cap='Comparing ROC and PR AUCs from bootstrapped calibrated model ensembles normalized to random model predictions - Topology vs Link-operator mutations (CASCADE 2.0, Bliss synergy method, Ensemble-wise results). We use the terminology "parameterization" to refer to the link operator mutations'}
# load the data
res = readRDS(file = "data/res_param_boot_aucs.rds")
...
```{r read-tumor-data, message = FALSE}
...
```{r mouse-xenograft-figure-1, dpi=300, cache=TRUE, fig.align='center', fig.cap='Average tumor volume and standard error of the mean (SEM) for the four groups of mice, per measurement day after tumor injection (1st day)'}
...
```{r survival-plot, dpi=300, cache=TRUE, fig.align='center', fig.cap='Mouse survival plot (Kaplan-Meier)'}
...
```{r mouse-xenograft-figure-2, dpi=300, cache=TRUE, fig.align='center', fig.cap='Comparing tumor volumes from all mice between Days 1 and 19.'}

...
The **ROC ensemble-wise statistics data** from the calibrated models are as follows:
```{r calibrated-bliss-dt, fig.align='center', fig.cap="ROC Ensemble-wise data for Calibrated Models (CASCADE 1.0, Bliss synergy method)"}
...
```{r best-beta-cascade2-link, fig.width=6, fig.height=6, fig.align='center', dpi=300, cache=TRUE, fig.show='hold', out.width='50%', fig.cap='ROC and PR curve for best beta (CASCADE 2.0, Link Operator Mutations)'}
best_beta1 = -1.6
best_beta2 = -1

...
```{r fit-evolution, dpi=300, fig.align='center', cache=TRUE, fig.cap='Fitness Evolution (CASCADE 1.0, HSA Results)'}
...
Note that in the cascade 2.0 configuration file we changed the number of simulations to ($15$) for each training data file and the attractor tool used was `biolqm_stable_states` (as is with every analysis in this report).

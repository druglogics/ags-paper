...
```{r quick-check-random-prolif-1000sim, eval=FALSE}
...
```{r fit-vs-perf-roc, message=FALSE, cache=TRUE, dpi=300, fig.align='center'}
...
```{r fit-vs-perf-pr, message=FALSE, cache=TRUE, dpi=300, fig.align='center'}

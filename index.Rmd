...
```{r PR HSA Cascade 2.0, fig.width=5, fig.height=5, dpi=300, cache=TRUE, fig.show='hold', out.width='50%'}
...
```{r PR AUC sensitivity (HSA - Cascade 2.0), dpi=300, out.width='80%', fig.align='center', cache=TRUE}
# Ensemble-wise
betas = seq(from = -20, to = 20, by = 0.1)
...
```{r PR Bliss Cascade 2.0, fig.width=5, fig.height=5, dpi=300, cache=TRUE, fig.show='hold', out.width='50%'}
...
```{r PR AUC sensitivity (Bliss - Cascade 2.0), dpi=300, out.width='80%', fig.align='center', cache=TRUE}
# Ensemble-wise
betas = seq(from = -20, to = 20, by = 0.1)
...
```{r Correlation of ROC results (Cascade 2.0), dpi=300, cache=TRUE}
synergy_scores = bind_cols(
